...
class ChatService extends AbstractHTTPService
{
	...
	public function messages(channel : BeamChannel, start : Int, end : Int, limit : Int) : Future<MessagesResponse>
	{
		...
		args.push(new Pair<String, Any>("id", channel.id));
		args.push(new Pair<String, Any>("start", start));
		args.push(new Pair<String, Any>("end", end));
		args.push(new Pair<String, Any>("limit", limit));
	...
	public function users(channel : BeamChannel, page : Int, limit : Int) : Future<OnlineUsersResponse>
	{
		var args : Array<Pair<String, Any>> = BeamHttpClient.getArgumentsBuilder();
		args.push(new Pair<String, Any>("id", channel.id));
		args.push(new Pair<String, Any>("page", page));
		args.push(new Pair<String, Any>("limit", limit));
	...
	public function usersSearch(userName : String, channel : BeamChannel, page : Int, limit : Int) : Future<OnlineUsersResponse>
	{
		...
		args.push(new Pair<String, Any>("limit", limit));
		args.push(new Pair<String, Any>("id", channel.id));
		args.push(new Pair<String, Any>("userName", userName));
	...
	public function updateSettings(channel : BeamChannel, linksAllowed : Bool, linksClickable : Bool, slowChat : Int) : Future<ChatSettingsResponse>
	{
		var args : Array<Pair<String, Any>> = BeamHttpClient.getArgumentsBuilder();
		args.push(new Pair<String, Any>("id", channel.id));
		args.push(new Pair<String, Any>("linksAllowed", linksAllowed));
		args.push(new Pair<String, Any>("linksClickable", linksClickable));
		args.push(new Pair<String, Any>("slowChat", slowChat));
